...
usersRouter.get('/users', validateToken_middleware_1.default, validateUser_middleware_1.default, Users_controller_1.default.getUserByName, error_middleware_1.default.handleErrors);
usersRouter.post('/users', Users_controller_1.default.createUser, error_middleware_1.default.handleErrors);
usersRouter.put('/users/:id', validateToken_middleware_1.default, Users_controller_1.default.updateUser, error_middleware_1.default.handleErrors);
